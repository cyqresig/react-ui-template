...
// get entry
const entryNameList = fs.readdirSync(path.join(EXAMPLES_FOLDER, MAIN_FOLDER)).map((filename) => {
...
entryNameList.forEach((entryName) => {
    webpackConfig.entry[entryName] = [
        path.join(__dirname, `../${EXAMPLES_FOLDER}/${MAIN_FOLDER}/${entryName}.js`),
    ]

    webpackConfig.plugins.push(new HtmlWebpackPlugin({
        template: `${EXAMPLES_FOLDER}/${VIEW_FOLDER}/index.html`,
